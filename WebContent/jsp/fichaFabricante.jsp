...
if (RequestUtils.getStringParameterFromHashMap(hashMap, "eliminar") != null) {
	...
	try {
		...
		response.sendRedirect(request.getContextPath() + "jsp/listaFabricante.jsp?idPag=1"); // Redirección del response hacia el listado
	} catch (Exception ex) {
		...
		<div class="mx-auto col-sm-6">
			...
			<div class="card">
				<div class="card-header">
					<h4 class="mb-0">Ficha Fabricante</h4>
				</div>
				<div class="card-body">

					<a href="listaFabricante.jsp?idPag=1">Ir a la lista de Fabricantes</a>
